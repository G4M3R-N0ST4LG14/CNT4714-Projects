...
<body>
    ...
    <div class="container">
        <h3>You are connected to the Project 3 Enterprise System database as a client-level user.<br>
        Please enter any SQL query in the box below.</h3>
        <form action="ClientUserServlet" method="post">
            <textarea name="sqlCommand"><%= request.getAttribute("sqlCommand") != null ? request.getAttribute("sqlCommand") : "" %></textarea><br>
